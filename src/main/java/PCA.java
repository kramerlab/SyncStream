...
public class PCA {
   ...
   public double[] getFirstPC() {
	    
	   double[] temp = new double[PC.getRowDimension()];
   ...
   */
  public boolean eigenPCA(Matrix data, boolean scale, boolean debug){
    // M dimensions
    // N trials
...
//        throw new Error("eigenPCA: mean of dimension " + (i+1) + " is 0.0");
    ...
    if(debug){
      ...
      data.print(data.getRowDimension(),10);
    }
    ...
    if(debug) {
      ...
      covariance.print(covariance.getRowDimension(), 10);
    }
    ...
    if(debug) {
      ...
      pc.getD().print(pc.getD().getRowDimension(), 15);
      System.out.println("EigenVectors");
      pc.getV().print(pc.getV().getRowDimension(), 15);
    }
    ...
    if(debug) {
      ...
      PC.print(PC.getRowDimension(), 15);
    }
